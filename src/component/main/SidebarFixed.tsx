...
const Sidebar = () => {
  const userDataDemo = localStorage.getItem("user_data");
  const userData = userDataDemo ? JSON.parse(userDataDemo) : null;
  ...
  return (
    <>
      <div className="h-full pt-[32px] bg-[var(--secondary)] sidebar">
